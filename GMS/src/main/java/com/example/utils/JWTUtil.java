...
public class JWTUtil {
    ...
    // 代表token的有效时间
    public final static long KEEP_TIME = 1800000000;
     ...
     * @param name 用户id
     * @param issuer 签发者->权限
//     * @param subject 一般用户名->姓名
     * @return String
     */
    public static String generateToken(String name, String issuer) {
        ...
        JwtBuilder builder = Jwts.builder().setId(name).setIssuedAt(now);
    ...
    public static String updateToken(String token) {
        ...
        // 生成新的token，根据现在的时间
        return generateToken(name, issuer);
    }
