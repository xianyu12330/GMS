...
import com.example.gms.dao.BorrowMapper;
...
public class borrowController {
    ...
    @GetMapping("/borrowByUser/{username}")
    public Result borrowByUser(@PathVariable String username){
        List<borrow> borrows = borrowMapper.borrowByUser(username);
        Result result = new Result(Code.SEARCH_SUC,"查询成功！");
